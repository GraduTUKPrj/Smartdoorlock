...
image_pathe =(r"C:\RPi4\Project")
image_paths={
    'Minjae' : image_pathe+'Minjae/',
    'Jiwoo': image_pathe+'Jiwoo/',
    'Haram' : image_pathe+'Haram/',
...
#인코딩파일 저장 
np.save('C:\RPi4\Project\desc\desc.npy', descs)
print(descs)

#이미지 삽입해서 확인하기
img_bgr = cv2.imread('C:\RPi4\Project\Minjae.jpg')
img_rgb = cv2.cvtColor(img_bgr,cv2.COLOR_BGR2RGB)
